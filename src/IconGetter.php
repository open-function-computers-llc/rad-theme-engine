...
class IconGetter
{
    ...
    public static function get(string $name)
    {
        if (!in_array($name, self::$iconList)) {
            echo "Sorry, that's not a valid Bootstrap icon name.".PHP_EOL;
            return;
        }

        $url = "https://icons.getbootstrap.com/assets/icons/$name.svg";
        $data = file_get_contents($url);
        if (!$data) {
            echo "Sorry, we couldn't fetch data from $url. Please check the icon name and try again.".PHP_EOL;
            return;
        }
